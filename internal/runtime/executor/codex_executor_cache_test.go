...
func TestCodexExecutorCacheHelper_OpenAIChatCompletions_StablePromptCacheKeyFromAPIKey(t *testing.T) {
	...
	if gotSessionUnderscore := httpReq.Header.Get("Session_id"); gotSessionUnderscore != "" {
		t.Fatalf("Session_id = %q, want empty (should use Session-Id with hyphen)", gotSessionUnderscore)
	}
